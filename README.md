# The Security and Artificial Intelligence Lab main website

Our website, http://saailab.github.io, is a [GitHub Pages](https://pages.github.com/) site built with [Jekyll](https://jekyllrb.com/) and [Bootstrap](http://getboostrap.com), originally pulled from [Trevor Bedford's site](http://bedford.io) and heavily modified.
...
If you're a member of the [SAI Lab team] you have access to the website repository.
